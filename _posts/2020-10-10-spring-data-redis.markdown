...
@EnableRedisRepositories(basePackages = "com.example.demo.repo")
...
File `RedisMessagePublisher.java`
...
File `RedisMessageSubscriber.java`
...
See result, use Postman or web browser:
