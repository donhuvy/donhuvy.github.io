---
layout: post
title:  "Run Kong API Gateway in Docker"
date:   2020-10-06 00:42:00 +0700
categories: Kong Docker Gateway
---
...
Use Konga for GUI: https://github.com/pantsel/konga . Office web GUI for enterprise edition.

From web browser, go to: [http://localhost:8001](http://localhost:8001/)
