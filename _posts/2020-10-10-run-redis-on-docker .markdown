...
You also maybe want use Redis for Windows (not official support: https://github.com/MicrosoftArchive/redis/releases/download/win-3.0.504/Redis-x64-3.0.504.msi). It will install at `C:\Program Files\Redis\`
